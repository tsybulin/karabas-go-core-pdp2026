...
module soft_switches(
	...
	always @(posedge clk) begin
		case (sw_command[15:8])
			...
			8'h03 : sw_bank[1:0]	<= sw_command[1:0] ;
			8'h04 : sw_bank[3:2]	<= sw_command[1:0] ;
			8'h05 : sw_bank[5:4]	<= sw_command[1:0] ;
			8'h06 : sw_bank[7:6]	<= sw_command[1:0] ;
			8'h07 : sw_color	<= sw_command[1:0] ;
			8'h08 : sw_leds	<= sw_command[0] ;
			8'h09 : sw_sound	<= sw_command[1:0] ;
		endcase
	end
